...
import { TsMultiplicationComponent } from './ts-multiplication/ts-multiplication.component';
...
@NgModule({
  declarations: [
    ...
    , AppSsoperComponent
    , DcSquareComponent
    , Slackntell6Component, ZpcSubtractComponent, TsMultiplicationComponent
  ],
  imports: [
    BrowserModule
    , FormsModule
